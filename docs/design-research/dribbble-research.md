...
Curated Dribbble shots and tag searches used as visual inspiration for this research. These cover the 5 key dimensions: color usage, card design, navigation patterns, hero sections, and player controls.

### Individual Shots (Direct Inspiration)

| #   | Shot / Designer                                                                                                            | Key Pattern                                                        | Dimension          |
| --- | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------ |
| 1   | [IPTV-Live TV Player Page — Mohammad Reza Farahzad / Orizon](https://dribbble.com/shots/20320006-IPTV-Live-TV-Player-Page) | Dark overlay player, minimal controls                              | Player Controls    |
| 2   | [ABC-IPTV PLAYER — Mohammad Reza Farahzad / Orizon](https://dribbble.com/shots/25298061-ABC-IPTV-PLAYER)                   | Channel list + player split layout, warm accent colors             | Navigation + Color |
| 3   | [IPTV Player Screenshot Design — Faizan Gohar](https://dribbble.com/shots/23156050-IPTV-Player-Screenshot-Design)          | Full-screen player with translucent control bar, thumbnail preview | Player Controls    |
| 4   | [Streaming app - TV UI — Timo Meyvisch](https://dribbble.com/shots/20215818-Streaming-app-tv-ui)                           | Horizontal content rail, large hero, focus-ring D-pad pattern      | Navigation + Hero  |

### StreamVault Applicability Notes

**Shot 1 (IPTV Live TV Player):** The dark gradient overlay behind player controls (bottom 30% darkens) protects text legibility without needing solid backgrounds. **Steal this** for StreamVault player overlay — use `background: linear-gradient(transparent, rgba(0,0,0,0.8))`.

**Shot 2 (ABC-IPTV Player):** Split-panel layout with channel list on left, player on right is ideal for desktop StreamVault EPG view. Warm amber/orange accent on selected channel creates visual hierarchy without overwhelming the dark background.

**Shot 3 (IPTV Player Screenshot):** Thumbnail scrubbing preview on hover over progress bar — a premium touch that signals quality. Apply to StreamVault HLS player seek bar.

**Shot 4 (Streaming TV UI):** Focus ring pattern — white border on focused card (not blue glow) — feels premium and TV-native. Steal for D-pad navigation focus styles.

### Dribbble Tag Collections (20+ References)

The following Dribbble tag pages each contain 35–7,000 designs reviewed for pattern extraction:

| #   | Tag Page                                                             | Pattern Coverage                        |
| --- | -------------------------------------------------------------------- | --------------------------------------- |
| 5   | [Streaming App UI](https://dribbble.com/tags/streaming-app-ui)       | Overall layout, hero patterns           |
| 6   | [IPTV](https://dribbble.com/tags/iptv)                               | Channel list, EPG grid, player          |
| 7   | [IPTV UI](https://dribbble.com/search/iptv-ui)                       | UI-specific IPTV patterns               |
| 8   | [IPTV Player](https://dribbble.com/tags/iptv-player)                 | Player overlay controls                 |
| 9   | [Streaming UI](https://dribbble.com/tags/streaming-ui)               | Streaming-specific UI elements          |
| 10  | [TV App UI](https://dribbble.com/tags/tv-app-ui)                     | TV remote/D-pad navigation              |
| 11  | [TV App](https://dribbble.com/tags/tv_app)                           | Broad TV app patterns                   |
| 12  | [Media Player](https://dribbble.com/tags/media-player)               | Player control bars, overlays           |
| 13  | [Video Player](https://dribbble.com/tags/video_player)               | Progress bars, scrubbing                |
| 14  | [Video Streaming App](https://dribbble.com/tags/video-streaming-app) | Content rail design, card aspect ratios |
| 15  | [Live TV](https://dribbble.com/tags/live-tv)                         | Live badge, channel schedule            |
| 16  | [EPG](https://dribbble.com/tags/epg)                                 | Program guide grid layouts              |
| 17  | [Streaming](https://dribbble.com/tags/streaming)                     | Broad streaming patterns                |
| 18  | [Live Streaming App](https://dribbble.com/tags/live_streaming_app)   | Live indicators, real-time UI           |
| 19  | [Dark Hero Section](https://dribbble.com/tags/dark-hero-section)     | Hero section with dark overlays         |
| 20  | [IPTV Stream Player Profile](https://dribbble.com/iptvstreamplayer)  | Cross-platform IPTV design system       |

### TV-First Patterns Identified (from Dribbble review)

1. **Focus rings over hover effects** — TV has no cursor; focus ring on active element is the only affordance (white/teal border, 2px, no shadow blur)
2. **Oversized typography** — TV viewed from 3m away; minimum 24px body text, 48px+ headings
3. **High contrast card thumbnails** — dark background + bright thumbnail creates natural focus; avoid light backgrounds
4. **Horizontal-first navigation** — Left/right D-pad movement is primary; content flows left→right in rails
5. **Persistent back button indicator** — TV remotes have dedicated back buttons; always show where "back" leads (breadcrumb or section heading)
